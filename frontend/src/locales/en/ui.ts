/** Chaînes EN des primitives d'interface (§4 i18n) — textes en dur des composants ui/. */
export default {
  ui: {
    motDePasse: {
    ...
    datePicker: {
      ...
      choisirMoisAnnee: 'Choose month and year',
      choisirAnnee: 'Choose year',
      decenniePrecedente: 'Previous decade',
      decennieSuivante: 'Next decade',
      anneePrecedente: 'Previous year',
      anneeSuivante: 'Next year',
      aujourdhui: 'Today',
      effacer: 'Clear',
      heure: 'Time',
    },
