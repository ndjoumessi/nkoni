...
export const messages = {
  // Refus de lecture/écriture sur une notification : inexistante OU appartenant à un autre
  // compte — MÊME message, pas de fuite d'existence.
  'notifications.introuvable': 'Notification introuvable.',
