/** Messages EN du domaine « tontines » (§ tontine, §4 i18n). */
export const messages = {
  'tontines.introuvable': 'Tontine not found.',
  'tontines.cycleIntrouvable': 'Tontine cycle not found.',
  'tontines.tourIntrouvable': 'Tontine round not found.',
  'tontines.participantsInsuffisants': 'At least two participants are required.',
