...
export const messages = {
  ...
  'import.quotaDepasse':
    'Import refused: creating {aCreer} active member(s) would push the total beyond {plafond} active members (free plan; {actuel} currently). Inactive or deceased records do not count. See the Settings page to change your plan.',
