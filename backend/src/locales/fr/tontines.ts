/** Messages FR du domaine « tontines » (§ tontine, §4 i18n). */
export const messages = {
  'tontines.introuvable': 'Tontine introuvable.',
  'tontines.cycleIntrouvable': 'Cycle de tontine introuvable.',
  'tontines.tourIntrouvable': 'Tour de tontine introuvable.',
  'tontines.participantsInsuffisants': 'Au moins deux participants sont requis.',
