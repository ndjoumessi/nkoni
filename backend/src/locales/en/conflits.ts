/** Messages EN du domaine « conflits » (§4 i18n). */
export const messages = {
  'conflits.introuvable': 'Conflict not found.',
  'conflits.accesRefuse': 'You do not have access to this conflict.',
  'conflits.niveauResponsableIncoherent':
