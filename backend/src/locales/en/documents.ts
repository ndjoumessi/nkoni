/** Messages EN du domaine « documents » (§4 i18n). */
export const messages = {
  'documents.introuvable': 'Document not found.',
  'documents.entiteParenteIntrouvable': 'The entity to attach the document to was not found.',
  ...
  'documents.champsRequisManquants':
    'Required fields missing or invalid (entiteType, entiteId, nom).',
}
